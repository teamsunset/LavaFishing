...
class ModelLobster<T : Entity>(private val rootPart: ModelPart) : HierarchicalModel<T>() {
    ...
    override fun setupAnim(
        ...
        if (pEntity is LivingEntity) {
            ...
            if (pEntity.onGround()) {
                ...
                animateWalk(ANIMATIONS["swim"], pLimbSwing, pLimbSwingAmount, 10F, Float.MAX_VALUE)
            }
        }
    }
