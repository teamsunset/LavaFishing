...
import club.redux.sunset.lavafishing.client.animation.AnimatedEntityAnimationEel
...
class ModelEel<T : Entity>(val root: ModelPart) : HierarchicalModel<T>() {
    ...
    override fun setupAnim(
        ...
        if (pEntity is LivingEntity) {
            ...
            animateWalk(
                AnimatedEntityAnimationEel.WALK,
                pLimbSwing,
                pLimbSwingAmount,
                5F,
                Float.MAX_VALUE
    ...
    companion object {
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            val whole =
                partdefinition.addOrReplaceChild("whole", CubeListBuilder.create(), PartPose.offset(0.0f, 24.0f, 20.0f))
            ...
            val body = whole.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(0.0f, -5.0f, -21.0f, 0.0f, -0.7418f, 0.0f)
            )
            ...
            val B3 = body.addOrReplaceChild(
                "B3",
                CubeListBuilder.create(),
                PartPose.offsetAndRotation(0.0f, 0.0f, 10.0f, 0.0f, 1.6144f, 0.0f)
            )
            ...
            val M = B3.addOrReplaceChild(
                "M",
                CubeListBuilder.create(),
                PartPose.offsetAndRotation(0.0f, 0.0f, 10.0f, 0.0f, -0.2618f, 0.0f)
            )
            ...
            val B6 = M.addOrReplaceChild(
                "B6",
                CubeListBuilder.create(),
                PartPose.offsetAndRotation(0.5f, -0.5f, 10.0f, 0.0f, -1.4399f, 0.0f)
            )
            ...
            val T = B6.addOrReplaceChild(
                "T",
                CubeListBuilder.create(),
                PartPose.offsetAndRotation(-0.5f, 0.5f, 8.0f, 0.0f, 0.0436f, 0.0f)
            )
            ...
            val bone8 = T.addOrReplaceChild(
                "bone8",
                CubeListBuilder.create(),
                PartPose.offsetAndRotation(0.0f, 0.0f, 8.0f, 0.0f, 1.5272f, 0.0f)
            )
