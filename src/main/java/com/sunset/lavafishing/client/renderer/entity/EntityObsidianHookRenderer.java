package com.sunset.lavafishing.client.renderer.entity;
...
public class EntityObsidianHookRenderer extends EntityRenderer<EntityObsidianHook>
{
    ...
    public EntityObsidianHookRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(EntityObsidianHook pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
