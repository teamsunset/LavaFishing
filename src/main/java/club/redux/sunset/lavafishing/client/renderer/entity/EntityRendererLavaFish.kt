...
class EntityRendererLavaFish(
    ...
    override fun getTextureLocation(fish: EntityLavaFish): ResourceLocation {
        return fish.getTexture(LavaFishing.resourceLocation("textures/entity/fish/default.png"))
    }
    ...
    override fun setupRotations(
        ...
        super.setupRotations(fishEntity, matrixStack, ageInTicks, rotationYaw, partialTicks, scale)
